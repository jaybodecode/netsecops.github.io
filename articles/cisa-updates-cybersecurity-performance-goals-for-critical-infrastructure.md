...
**Severity:** informational | **Category:** Policy and Compliance,Regulatory | **Updated:** 2025-12-13 | **Reading time:** 3 min
...
## Executive Summary
On December 11, 2025, the **[U.S. Cybersecurity and Infrastructure Security Agency (CISA)](https://www.cisa.gov)** published an updated version of its voluntary Cybersecurity Performance Goals (CPGs). These CPGs serve as a recommended baseline of fundamental cybersecurity practices for all critical infrastructure entities. The latest revision incorporates alignments with recent updates to **[National Institute of Standards and Technology (NIST)](https://www.nist.gov/)** frameworks and introduces a heightened focus on governance and accountability. The goal is to provide organizations, particularly small and medium-sized ones, with a clear, prioritized set of actions to significantly reduce risk from the most common cyber threats.
...
*   **[Healthcare](https://www.aha.org/news/headline/2025-12-12-cisa-issues-update-voluntary-cybersecurity-performance-goals)** and Public Health
*   Energy
*   Financial Services
...
**Tags:** CISA, CPG, Cybersecurity Performance Goals, Critical Infrastructure, NIST, Governance, Policy

## Sources
- [CISA issues update on voluntary cybersecurity performance goals](https://www.aha.org/news/headline/2025-12-12-cisa-issues-update-voluntary-cybersecurity-performance-goals) — AHA News (2025-12-12)
...
---
Source: https://cyber.netsecops.io/articles/cisa-updates-cybersecurity-performance-goals-for-critical-infrastructure/
