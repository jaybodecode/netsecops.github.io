...
**Severity:** informational | **Category:** Threat Intelligence,Policy and Compliance | **Updated:** 2026-07-11 | **Reading time:** 3 min
...
- **NIST PQC Standardization:** The U.S. National Institute of Standards and Technology (**[NIST](https://www.nist.gov)**) is in the final stages of standardizing a suite of PQC algorithms designed to be resistant to attack from both classical and quantum computers.
- **NSA CNSA 2.0:** The U.S. National Security Agency (**[NSA](https://www.nsa.gov)**) has released its Commercial National Security Algorithm Suite 2.0, which mandates timelines for transitioning to quantum-resistant algorithms for national security systems.
...
**Tags:** Post-Quantum Cryptography, PQC, Quantum Computing, Q-Day, NIST, Encryption, Cybersecurity

## Sources
- [QIZ Security secures $17 million to address post-quantum cryptographic risks facing critical infrastructure](https://industrialcyber.co/__sentry?ctype=balanced&uri=/news/qiz-security-secures-17-million-to-address-post-quantum-cryptographic-risks-facing-critical-infrastructure/) — Industrial Cyber (2026-07-10)

---
Source: https://cyber.netsecops.io/articles/qiz-security-raises-17m-to-tackle-post-quantum-cryptographic-risks/
