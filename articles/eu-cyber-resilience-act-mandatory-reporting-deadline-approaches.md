...
A critical deadline for the **[European Union](https://european-union.europa.eu/)**'s Cyber Resilience Act (CRA) is fast approaching. Starting September 11, 2026, manufacturers of "products with digital elements" (PDEs) sold in the EU will be legally required to report actively exploited vulnerabilities and severe security incidents to government authorities within 24 hours of becoming aware of them. This requirement, outlined in Article 14 of the CRA, comes into effect more than a year before the rest of the regulation, placing immediate pressure on companies to establish rapid incident identification and reporting capabilities. Non-compliance can result in significant penalties and market access restrictions.
...
-   **24-Hour Early Warning**: An initial notification must be sent to the **[EU Agency for Cybersecurity (ENISA)](https://www.enisa.europa.eu/)** and the relevant national Computer Security Incident Response Team (CSIRT) within 24 hours of awareness.
...
To manage this process, **[ENISA](https://www.enisa.europa.eu/)** is launching a Single Reporting Platform, expected to be live by the deadline.
...
2.  **Develop a Playbook**: Document a clear, step-by-step process for identifying a reportable event, gathering the required information, and submitting the notification to **[ENISA](https://www.enisa.europa.eu/)** within 24 hours.
3.  **Define 'Awareness'**: Work with legal counsel to define the internal threshold for when the 24-hour clock starts. The **[European Commission](https://commission.europa.eu/)** has stated it begins upon reaching a "reasonable degree of certainty."
...
**Tags:** CRA, Compliance, Cyber Resilience Act, ENISA, EU, Regulation

## Sources
- [Cyber Resilience Act reporting obligations take effect on 11 September 2026](https://www.freshfields.com/en/our-thinking/blogs/technology-quotient/cyber-resilience-act-reporting-obligations-take-effect-on-11-september-2026-102nzmk) (2026-08-31)

---
Source: https://cyber.netsecops.io/articles/eu-cyber-resilience-act-mandatory-reporting-deadline-approaches/
