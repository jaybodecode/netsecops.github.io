...
**Severity:** informational | **Category:** Regulatory,Policy and Compliance,Ransomware | **Updated:** 2026-02-23 | **Reading time:** 4 min
...
## Executive Summary
The **[U.S. Department of the Treasury](https://home.treasury.gov/)**'s Office of Foreign Assets Control (OFAC) has taken significant action to combat cybercrime by sanctioning two prominent cryptocurrency mixing services, **VortexCash** and **Cyclone**. These services have been added to the Specially Designated Nationals (SDN) list, effectively cutting them off from the U.S. financial system. The Treasury's investigation revealed that these mixers were instrumental in laundering hundreds of millions of dollars for state-sponsored hacking groups and major ransomware gangs. Specifically, **VortexCash** was linked to the North Korean **[Lazarus Group](https://attack.mitre.org/groups/G0032/)**, while **Cyclone** was a favored tool of the **[Conti](https://attack.mitre.org/groups/G0102/)** and **[Ryuk](https://attack.mitre.org/software/S0466/)** ransomware operations. This move is part of a broader U.S. government strategy to disrupt the financial ecosystem that enables ransomware and other illicit cyber activities.
...
- **[Lazarus Group](https://attack.mitre.org/groups/G0032/)** (North Korean state-sponsored APT)
- **[Conti](https://attack.mitre.org/groups/G0102/)** ransomware group
- **[Ryuk](https://attack.mitre.org/software/S0466/)** ransomware group
...
**Tags:** Sanctions, OFAC, Cryptocurrency, Mixer, Ransomware, Lazarus Group, Conti, Ryuk

## Sources
- [Treasury Sanctions Two Cryptocurrency Mixers Facilitating Ransomware Payments and Illicit Finance](https://home.treasury.gov/news/press-releases/jy2123) — U.S. Department of the Treasury (2026-02-23)
- [US Treasury Sanctions Crypto Mixers VortexCash and Cyclone for Laundering Cybercrime Proceeds](https://www.coindesk.com/policy/2026/02/23/us-treasury-sanctions-crypto-mixers-vortexcash-and-cyclone/) — CoinDesk (2026-02-23)

---
Source: https://cyber.netsecops.io/articles/us-treasury-announces-new-sanctions-on-cryptocurrency-mixers/
